// Direct job insertion script without .env dependency
...
const connectDB = async () => {
  try {
    // Prefer env, otherwise default to jobsnapDB
...
const generateMoreJobs = () => {
  ...
  const technologies = [
    ...
    'Redis', 'Elasticsearch', 'Machine Learning', 'AI', 'TensorFlow', 'PyTorch'
  ];
  ...
  const jobTitles = [
    ...
    'Cloud Engineer', 'Solutions Architect', 'Technical Writer', 'Developer Advocate'
  ];
  ...
  const locations = [
    ...
    'Sydney, Australia', 'Singapore', 'Tokyo, Japan', 'Dublin, Ireland'
  ];
